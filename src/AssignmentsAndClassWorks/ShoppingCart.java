package AssignmentsAndClassWorks;//package tdd.AssignmentsAndClassWorks;
...
//    }
//
//    public ArrayList<CustomerAndCashierName> getNames() {
//        return names;
//    }
//
...
//        double subTotal = 0.0;
//        for (ShoppingCartItems item : totalItems) {
...
//            item = item.formatted(items.getItems(), items.getQuantity(), items.getPrice(), (items.getQuantity()*items.getPrice()));
//            totalItem += item;
//        }
//        double total = 0;
